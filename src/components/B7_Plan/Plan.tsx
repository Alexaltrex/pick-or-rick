...
const text = "We know it gets boring living in your wifes boyfriends basement so heres a game we made to keep you busy until launch :)";
...
export const Plan = () => {
    return (
        <div className={style.plan}>
            ...
            <h2 className={style.title}>heres the plan morty</h2>
            ...
            <div className={style.pots}>
                {
                    [
                        ...
                        },
                        {
                            src: pot1,
                            label: "q2: half degen",
                            text: "Empty a pickle jar and put everyones money in it...",
                        },
                        {
                            src: pot2,
                            label: "q3: pickgen",
